...
path2 = '/Users/emilytemple/documents/rsmbh-agn-fit2.0/pyqsofit/Fit Results/Outliers_Noisy/'     
...
def runscript_func(sourcename):
    ...
    if not os.path.exists(path2+'/'+sourcename):
        os.makedirs(path2+'/'+sourcename)
    ...
    path5 = '/Users/emilytemple/documents/rsmbh-agn-fit2.0/pyqsofit/Fit Results/Outliers_Noisy/'+sourcename+'/'
...
# else:
#     runscript_func('0270-51909-0543')
...
if loop:
    ...
    runscript_func('0273-51957-0008')
